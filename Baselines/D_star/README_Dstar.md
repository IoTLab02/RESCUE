# Running D* Evacuation Pipeline

This document explains the **D*** pipeline used for iterative wildfire evacuation simulations.  
...
Files:
· D*.py → runs D* and generates evacuee paths (*_path_objectives.txt)
...
1. Run D*.py
   o Input:
      ...
      - Seattle_node.csv (or your node coord file)
        (https://figshare.com/articles/dataset/A_unified_and_validated_traffic_dataset_for_20_U_S_cities/24235696?file=48908890)
   o Output:
      - *_path_objectives.txt
      
Command to run: python3 D*.py
```
...
python3 main_create_changed_edges.py   -z  "/Users/stb34/Documents/wildfire/Experiments/Seattle/Original_fire_probabality_zone.csv"   -w  "/Users/stb34/Documents/wildfire/Experiments/Seattle/final_edge_weights_directional.csv"   -f  "/Users/stb34/Documents/wildfire/Experiments/Seattle/directional_flow_only.csv"   -p  "/Users/stb34/Documents/wildfire/Experiments/D*/Seattle_path_objectives.txt"   -e 25   -i 1

(Note: In the first iteration, the process uses final_edge_weights_directional.csv as the input graph and Seattle_path_objectives.txt which contains the paths generated from the first D* run.)

Example 2nd iteration:
python3 main_create_changed_edges.py   -z  "/Users/stb34/Documents/wildfire/Experiments/Seattle/Original_fire_probabality_zone.csv"   -w  "/Users/stb34/Documents/wildfire/Experiments/D*/updated_graph.csv"   -f  "/Users/stb34/Documents/wildfire/Experiments/Seattle/directional_flow_only.csv"   -p  "/Users/stb34/Documents/wildfire/Experiments/D*/Seattle_path_objectives.txt"   -e 25   -i 2
...
3. Repeat for iterations 1 → 4
   o Always feed the new updated_graph.csv into the next D* run.
